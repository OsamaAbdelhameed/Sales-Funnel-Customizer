...
import { Video, Download, Play, Square, Settings, RefreshCw, ArrowRight, Sparkles, Layout, FileText, Zap } from 'lucide-react';
    ...
    <div className="bg-[#050510] text-slate-100 overflow-x-hidden font-sans">
          ...
          <main className="flex-1 flex flex-col items-center justify-center p-8 gap-12">
            ...
            >
              ...
              <p className="text-slate-400 text-xl leading-relaxed max-w-2xl mx-auto">
                Build stunning websites, dynamic PDFs, and interactive questionnaires. 
                Experience the first sales engine that feels as good as it performs.
              </p>
      ...
      <section className="py-32 bg-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-16 text-black">Trusted by the Future</h2>
          <Sponsors />
        </div>
      </section>
      ...
      <section className="py-32 bg-indigo-600 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center text-white relative z-10">
          <h2 className="text-5xl font-bold mb-8 italic tracking-tighter">Ready to dominate the market?</h2>
          <p className="text-2xl mb-12 text-indigo-100 max-w-2xl mx-auto">
            Take control of your entire customer journey from a single, unified visual dashboard.
          </p>
          <div className="flex justify-center gap-6">
            <Link href="/dashboard" className="px-12 py-6 rounded-2xl bg-white text-indigo-600 font-bold text-xl hover:scale-105 transition-transform shadow-2xl">
              Get Started Now
            </Link>
          </div>
        </div>
